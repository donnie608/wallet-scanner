...
def create_eth_card(token_name, wallet, tokens, cost_usd, value_usd, profit_usd, roi,
                    logo_path=None, token_symbol=None,
                    buy_count=0, sell_count=0):
    """ETH full card — same as create_card now that both chains use USD."""
    create_card(token_name, wallet, tokens, cost_usd, value_usd, profit_usd, roi,
                logo_path=logo_path, token_symbol=token_symbol,
...
def create_minimal_eth_card(token_name, profit_usd, roi,
                             logo_path=None, token_symbol=None,
                             avg_buy_price=0, current_price=0):
    """ETH minimal card — same as create_minimal_card now that both chains use USD."""
    create_minimal_card(token_name, profit_usd, roi,
                        logo_path=logo_path, token_symbol=token_symbol,
