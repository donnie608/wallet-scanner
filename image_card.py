...
# =========================
# FULL CARD — SOL layout, historical USD cost
# =========================
def create_card(token_name, wallet, tokens, cost, value, profit, roi,
                logo_path=None, token_symbol=None,
                buy_count=0, sell_count=0,
                sol_price_usd=0,
                cost_usd_historical=None):
    """
    SOL-based card. All values shown in SOL with USD in parentheses.
    cost_usd_historical: if provided, used for the Cost USD instead of cost * sol_price_usd.
                         This gives accurate historical cost instead of spot-price cost.
    """
    ...
    # VALUES — SOL with USD in parentheses
    # Cost USD: use historical if provided, otherwise fall back to spot price
    if cost_usd_historical is not None:
        cost_usd = cost_usd_historical
    else:
...
# =========================
# MINIMAL CARD (RESTORED — unchanged from original)
# =========================
